...
const FormItems: React.FC<{}> = _props => {
    ...
    return (
        <>
            ...
            <Row>
                <Col span={24}>
                    <Form.Item name='recordDesc' label="备注" labelCol={{ span: 3 }} wrapperCol={{ span: 21 }}>
